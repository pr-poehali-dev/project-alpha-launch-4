...
const highlights = [
  {
    ...
    description:
      "Hottie Fest — единственный в регионе чемпионат, посвящённый исключительно женским танцевальным направлениям. Уникальный формат привлекает специализированную аудиторию и создаёт особую атмосферу.",
  ...
  },
  {
    ...
    description:
      "Освещение в ВКонтакте, Телеграм, Инстаграм и личных страницах организаторов. Анонсы, посты о партнёрах и репортажи с мероприятия обеспечивают максимальную видимость бренда.",
